...
engine = create_engine("postgres://bpvmzwecssmefd:3de40800289f2251c3192849dcfc0fec4216bc90b080f60a8d77efd37156b278@ec2-184-73-210-189.compute-1.amazonaws.com:5432/d7ehdb25kv3pkv", echo=False)
...
bugprobabilities_table = Table('BugProbablities', metadata, autoload=True)
